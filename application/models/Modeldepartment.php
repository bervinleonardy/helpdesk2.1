...
{
    var $table = 'department'; //nama tabel dari database
    var $column_order = array(null, 'name', 'created_date', 'created_by', null); //Sesuaikan dengan field
    ...
    public function simpan($nama, $createdBy)
    {
        $simpan = [
            'name'          => $nama,
    ...
    public function update($id, $nama, $modifiedBy, $modifiedDate)
    {
        $simpan = [
            'name'           => $nama,
