        ...
        <div class="col-lg-12">
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    ...
                    <?= form_open('superadmin/deletemultipledepartment', ['class' => 'formhapus']); ?>
                    <button type="button" class="btn btn-primary mb-3" id="tomboltambah">
                        <i class="fa fa-plus-circle"> Add Department</i>
                    </button>
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered display nowrap" id="dataDepartment" width="100%" cellspacing="0">
                            <thead>
                                <tr>
                                    <th>
