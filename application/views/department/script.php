...
<script>
  function tampildatadepartment() {
    ...
    table = $('#dataDepartment').DataTable({
      responsive: true,
      "destroy": true,
      "processing": true,
      "serverSide": true,
      ...
      "ajax": {
        "url": "<?= site_url('superadmin/getDataDepartment') ?>",
        "type": "POST"
      },
  ...
  function edit(id) {
    $.ajax({
      type: 'post',
      url: "<?= site_url('superadmin/formeditdepartment'); ?>",
      data: {
        id: id
      },
      dataType: "json",
  ...
  function hapus(id, name) {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        $.ajax({
          type: 'post',
          url: "<?= site_url('superadmin/hapusdepartment'); ?>",
          data: {
            id: id
          },
          dataType: "json",
  ...
  $(document).ready(function() {
    ...
    $('#tomboltambah').click(function(e) {
      $.ajax({
        url: "<?= site_url('superadmin/formtambahdepartment'); ?>",
        dataType: "json",
        success: function(response) {
          if (response.sukses) {
            $('.viewmodal').html(response.sukses).show();
