    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <?= form_open('superadmin/deletemultiplemanager', ['class' => 'formhapus']); ?>
                    <button type="button" class="btn btn-primary mb-3" id="tomboltambah">
                        <i class="fa fa-plus-circle"> Add Manager</i>
                    </button>
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered display nowrap" id="dataManager" width="100%" cellspacing="0">
                            <thead>
                                <tr>
                                    <th>
