...
<script>
  ...
  function hapus(id, name) {
    Swal.fire({
      title: 'Delete',
      text: `Are you sure delete menu : ${name} ?`,
      icon: 'warning',
  ...
  $(document).ready(function() {
    ...
    $('.formhapus').submit(function(e) {
      ...
      if (jmldata.length === 0) {
        ...
        Swal.fire({
          title: 'Delete Data',
          text: `There's ${jmldata.length} data menu will be delete ?`,
          icon: 'warning',
          showCancelButton: true,
          confirmButtonColor: '#3085d6',
          cancelButtonColor: '#d33',
