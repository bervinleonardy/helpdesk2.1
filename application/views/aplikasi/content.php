        ...
        <div class="col-lg-12">
            ...
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">Application Table</h6>
                </div>
                <div class="card-body">

                    <?= form_open('apps/deletemultipleapps', ['class' => 'formhapus']); ?>
                    <button type="button" class="btn btn-primary mb-3" id="tomboltambah">
                        <i class="fa fa-plus-circle"> Add Application</i>
                    </button>
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered display nowrap" id="dataApps" width="100%" cellspacing="0">
                            <thead>
                                <tr>
                                    <th>
