        ...
        <div class="col-lg-12">
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    ...
                    <?= form_open('manager/closemultipleticket', ['class' => 'formclose']); ?>
                    <button type="submit" class="btn btn-success mb-3" id="tombolCloseBanyak">
                        <i class="fas fa-check"> Closed Ticket</i>
                    </button>
